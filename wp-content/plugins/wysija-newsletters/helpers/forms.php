...
class WYSIJA_help_forms{
    ...
    function WYSIJA_help_forms(){
        $this->eachValues=array(
                            ...
                            'one_min'=> __('jede Minute',WYSIJA),
                            'two_min'=> __('alle 2 Minuten',WYSIJA),
                            'five_min'=> __('alle 5 Minuten',WYSIJA),
                            'ten_min'=> __('alle 10 Minuten',WYSIJA),
                            'fifteen_min'=> __('alle 15 Minuten',WYSIJA),
                            'thirty_min'=> __('alle 30 Minuten',WYSIJA),
                            'hourly'=> __('jede Stunde',WYSIJA),
                            'two_hours'=> __('alle 2 Stunden',WYSIJA)
                            //'twicedaily'=> __('twice daily',WYSIJA),
                            //'daily'=> __('once a day',WYSIJA)
                            );
