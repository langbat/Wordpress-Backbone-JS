...
function et_get_current_customization($type = false) {
    ...
    if ($type == false)
        return $values;
    else if (array_key_exists($type, $values))
        return $values[$type];
    else
        return false;
}
...
// ...  deleted ... 
// TEMPLATE;
    //$template = include dirname(__FILE__) . '/../template-job.php';  // use the same template for all job-lists
    // NOTE: using a php template might not work for js. need to doublecheck later. may fallback to a js-specific-template-file
...
if (!function_exists('je_modal_edit_job_template')) {
    ...
    function je_modal_edit_job_template($job_data) {
        $job_types = et_get_job_types();
        ?>
        <!-- modal: Edit a job -->
        <div class="modal-job" id="modal_edit_job">
            <div class="edit-job-inner">
                <div class="title "><?php _e('EDIT THIS JOB', ET_DOMAIN) ?></div>
                <div class="modal-form">
                    <form id="job_form">
                                    ...
                                    <div id="job-details">
                                        ...
                                        <div class="form-item">
                                            ...
                                            <div class="apply">
                                                ...
                                                <label class="" for="ishowtoapply" ><?php _e("Or, provide application details below", ET_DOMAIN); ?></label>
                                        ...
                                        <div class="form-item select_verband">
                                            <div class="label">
                                        ...
                                        <div class="job_fields">
                                            <div class="form-item" id="load_conditions_by_job_type">
                                                
                                            </div>
                                        </div>
                                    </div>
                                    <div id="company-details"> 
                                        <div class="form-label padding-top30 ">
                                            <?php _e('Company Details', ET_DOMAIN) ?>
                                        </div>
                                        <div class="form-item f-left-all">
                                            <?php
                                            $company = et_create_companies_response($job_data['author_id']);
                                            ...
                                            <div class="input-file logo f-left" id="user_logo_container">
                                                ...
                                                <div id="user_logo_thumbnail" class="thumbs">
                                                    <?php
                        ...
                        <div class="footer ">
                            <div class="button">
                                <!--<a href="#" id="save-jobe-single" class="btn">Click Me</a> -->
                                <div id="submit-form" class="bg-btn-action border-radius"><?php _e('SAVE CHANGE', ET_DOMAIN) ?></div>
                            </div>     
                        </div>
                    </form>
                </div>
...
function je_header_menu() {
    ...
    $company_selected = '';
    if ($sel == 'job')
        $job_selected = 'current-menu-item';
    if ($sel == 'company')
        $company_selected = 'current-menu-item';
