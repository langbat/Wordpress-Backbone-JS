         ...
         >
             <?php foreach ($slides as $slide): ?>
                ...
                <div class="cycloneslider-slide cycloneslider-slide-image" <?php echo cyclone_slide_settings($slide, $slider_settings); ?> 
                     style="background: url(<?php echo cyclone_slide_image_url($slide['id'], $slider_settings['width'], $slider_settings['height'], array('current_slide_settings' => $slide, 'slideshow_settings' => $slider_settings)); ?>) no-repeat transparent top center; -moz-background-size: cover; background-size: cover;" >
