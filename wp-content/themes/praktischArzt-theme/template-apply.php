...
<div class="form_container form_apply_job">	
    ...
    <?php
    if ($job->post_status == 'publish' || $user_ID == $job->post_author ||
    ...
    if ($options->et_resumes_status) {
        ...
        <div class="bg-job-frame job-apply clearfix margin-top25" id="apply_form" style="display:none">
            <div class="auth-apply">
                <h3 class="title"><?php _e("Use your professional profile to apply", ET_DOMAIN); ?> </h3>
                <!-- user logged in -->
            ...
            <div class="unauth-apply <?php if (is_user_logged_in()) echo 'hide' ?>">
                ...
                <h3 class="title"><?php _e("Or send your application quickly without registration", ET_DOMAIN); ?></h3>
                <form class="form" id="applicationForm" >                      
                    <div class="form-item no-padding">
                        <div class="width50 f-left">
                            <div class="label">
                                <h6><?php _e("First name", ET_DOMAIN); ?></h6>
                            </div>
                            <div class="">
                        ...
                        <div class="width50 f-left">
                            <div class="label">
                                <h6><?php _e("Last name", ET_DOMAIN); ?></h6>
                            </div>
                            <div class="">
                                <input name="apply_last_name" id="apply_last_name" type="text" class="bg-default-input required" value="<?php if (isset($_COOKIE['seeker_last_name'])) echo $_COOKIE['seeker_last_name']; ?>"/>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                        <div class="width50 f-left">
    ...
    <?php if ($apply_method == 'ishowtoapply' || $user_ID == $job->post_author || current_user_can('manage_options')) { ?>  
