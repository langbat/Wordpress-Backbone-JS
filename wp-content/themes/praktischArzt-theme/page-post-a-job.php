        ...
        jQuery(document).ready(function() {
            ...
            $("select#job_types").change(function() {
                ...
                if (job_types == 'assistenzarzt') {
                    $("#load_conditions_by_job_type").parent().hide();
                }
                else {
                    $("#load_conditions_by_job_type").parent().show();
                }
                                ...
                                <div class="clear row-fluid">
                                    <div class="clearfix span4 payment_plan basis">
                                        ...
                                        <ul class="clearfix announcement type_regular " id="type_regular_<?php echo $plan['ID']; ?>">
                                            <li>
                                                <input type="checkbox" id="regular_facebook_<?php echo $plan['ID']; ?>" value="facebook" class="price_facebook" data-regular="99" > <label for="regular_facebook_<?php echo $plan['ID']; ?>">Facebook-Annonce <b><span>99.00 €</span></b></label>
                                            </li> 
                                            <li>
                                                <input type="checkbox" id="regular_blog_<?php echo $plan['ID']; ?>" value="blog" class="price_blog" data-regular="179" > <label for="regular_blog_<?php echo $plan['ID']; ?>">Blog-Annonce <b><span>179.00 €</span></b></label>
                                            </li>
                                            <li>
                                                <input type="checkbox" id="regular_newsletter_<?php echo $plan['ID']; ?>" value="newsletter" class="price_newsletter" data-regular="79" > <label for="regular_newsletter_<?php echo $plan['ID']; ?>">Newsletter-Annonce <b><span>79.00 €</span></b></label>
                                            </li>
                                        </ul>
                                        <ul class="clearfix announcement type_reduced" id="type_reduced<?php echo $plan['ID']; ?>">
                                            <li>
                                                <input type="checkbox" id="reduced_facebook_<?php echo $plan['ID']; ?>" value="facebook" class="price_facebook" data-reduced="69"> <label for="reduced_facebook_<?php echo $plan['ID']; ?>">Facebook-Annonce <b><span>69.00 €</span></b></label>
                                            </li> 
                                            <li>
                                                <input type="checkbox" id="reduced_blog_<?php echo $plan['ID']; ?>" value="blog" class="price_blog" data-reduced="179"> <label for="reduced_blog_<?php echo $plan['ID']; ?>">Blog-Annonce <b><span>179.00 €</span></b></label>
                                            </li>
                                            <li>
                                                <input type="checkbox" id="reduced_newsletter_<?php echo $plan['ID']; ?>" value="newsletter" class="price_newsletter" data-reduced="49"> <label for="reduced_newsletter_<?php echo $plan['ID']; ?>">Newsletter-Annonce <b><span>49.00 €</span></b></label>
                                            </li>
                                        </ul>
                                    ...
                                    <div class="clearfix span4 payment_plan premium" >
                                        ...
                                        <span class="plan_teaser">
                                            ...
                                            <ul>
                                                ...
                                                <li class="checked"> Platzierung über den Top-Anzeigen</li>
                                    ...
                                    <div id="job_info">
                                        ...
                                        <div class="form-item">
                                            ...
                                            <div class="apply">
                                                ...
                                                <label class="" for="ishowtoapply" ><?php _e(" Arbeitsuchende müssen folgende Schritte ausführen", ET_DOMAIN); ?></label>
                                ...
                                <form method="post" action="" id="checkout_form">
                                    ...
                                    <ul>
                                        ...
                                        <li class="clearfix">
                                            ...
                                            <div class="f-right">
                                                <div class="btn-select ">
                                                    <div style="padding-left: 10px !important;" class="btn bg-btn-hyperlink border-radius select_payment_debit" data-price="" data-gateway="debit" > Jetzt kaufen</div>
                                                </div> 
                                                ...
                                                <div id="form_payment_debit">
                                                    ...
                                                    <div class="control-group">
                                                        ...
                                                        <input type="text" class="icon-euro" id="inputAmount" placeholder="Rechnungsbetrag" readonly="readonly" /> 
                                                    </div>
                                                    <div class="control-group">
                                                    ...
                                                    <div class="clearfix"></div>
                                                    <div class="btn-select"> 
                                                        <div style="padding-left: 10px !important;" class="btn bg-btn-hyperlink border-radius payment_debit" data-price="" data-gateway="debit" >Jetzt kaufen</div>
                                                    </div> 
                                                </div>
                                            </div> 
                                        </li>
