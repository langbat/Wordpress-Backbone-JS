...
class JE_Resume extends ET_Base{
    ...
    static $fields = array('et_education', 'et_experience', 'et_location', 'et_url', 'et_profession_title' , 'je_include_search', 'et_privacy' , 'et_privacy_post_name');
    ...
    public function meta_box_information($post){
        ...
        <h4><?php _e('Education background', ET_DOMAIN) ?></h4>
        <div id="edu_info">
            <?php $index = 0; ?>
        ...
        <h4><?php _e('Work Experience', ET_DOMAIN) ?></h4>
        <div id="exp_info">
            <?php 
