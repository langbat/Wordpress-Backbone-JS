...
JobEngine.Views.PageProfileManage = Backbone.View.extend({
	...
	'events' 	: {
		...
		'change .jobpos_select select' 		: 'addJobPosition'
	},
	...
	// onToggleInlineEditInfo : function(event){		
	// 	event.preventDefault();
	// 	var width = parseInt($(".edu-content").css('width')) - 7 ;
	// 	var height = parseInt($(".edu-content").css('height')) + 20;
	// 	$(".info-resume textarea").css('height',height);
	// 	$(".info-resume textarea").css('width',width);
	// 	//tinyMCE.execCommand('mceAddControl', true, 'edu-content');
	// 	var element 	= $(event.currentTarget);
	// 	var container 	= element.closest('.module');
	// 	///$('.module').removeClass ('editing');
	// 	$(container).toggleClass ('editing');
	// 	// this.toggleInlineEdit(container);
	// },
