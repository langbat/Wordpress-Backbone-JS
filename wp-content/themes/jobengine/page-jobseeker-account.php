<?php 
/**
 * Template Name: Bewerber Account
 */
...
<div class="tab-account">
	<div class="main-center">
		...
		<a href="<?php echo get_permalink( $ower_resume->ID ) ?>" title="<?php __("View your Profile", ET_DOMAIN) ?>" class="view-profile"><?php _e("View your Profile", ET_DOMAIN); ?></a>
	</div>
</div>
