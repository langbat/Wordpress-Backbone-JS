...
$invoice_mail = $mailt_opt->get_invoice_mail();
?>
<style type="text/css">
    .email-template .form {display: none;}
    .title_template_email{
...
<div class="et-main-main clearfix inner-content" id="setting-mail-template"  <?php if ($sub_section != 'mail-template') echo 'style="display:none"' ?> >
    ...
    <div class="desc" id="job-mail-template">
        ...
        <div class="inner email-template" >
            <div class="item">
                <div class="payment">
                    <div class="title_template_email">
...
<!-- <textarea name="reject_mail" id="reject-mail" style="width:100%;"><?php echo $reject_mail ?></textarea> -->
            ...
            <div class="item">
                <div class="payment">
                    <div class="title_template_email">
                        <?php _e("Senden dem Arbeitgeber eine E-Mail, wenn er eine Stelle erstellt.", ET_DOMAIN); ?>
                    </div>
                    <div class="button-enable font-quicksand enable-email">
            ...
            <div class="item">
                <div class="payment">
                    <div class="title_template_email">
                        <?php _e("Senden dem Arbeitgeber eine Rechnung, nachdem Zahlung fertig ist.", ET_DOMAIN); ?>
                    </div>
                    <div class="button-enable font-quicksand enable-email">
                        <a href="#" rel="mail_invoice" title="Disable" class="deactive <?php echo $auto_email['invoice_notice'] == 0 ? 'selected' : '' ?>">
                            <span>Disable</span>
                        </a>
                        <a href="#" rel="mail_invoice" title="Enable" class="active <?php echo $auto_email['invoice_notice'] == 1 ? 'selected' : '' ?>">
                            <span>Enable</span>
                        </a>
                    </div>
                </div>	    
                <div class="form payment-setting">
                    <div class="form-item">
                        <div class="mail-template">
                            <div class="mail-input">
                                <?php wp_editor($invoice_mail, 'invoice_mail', je_editor_settings()); ?> 
                                <span class="icon" data-icon="3"></span>
                            </div>
                            <div class="mail-control-btn">
                                <div>(*)[reason] : <?php _e("reason when payment successfull ", ET_DOMAIN) ?></div>
                                <a href="#" class="trigger-editor" ><?php _e('Toggle Editor', ET_DOMAIN) ?></a> | <a href="#" class="reset-default" ><?php _e('Reset to default', ET_DOMAIN) ?></a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="item">
                <div class="payment">
                    <div class="title_template_email">
                        <?php _e("Sandte eine Botschaft für Verwaltung, um Arbeitsplätze auf Facebook Arbeit und newletter Blog veröffentlichen.", ET_DOMAIN); ?>
                    </div>
                    <div class="button-enable font-quicksand enable-email">
                        <a href="#" rel="mail_admin" title="Disable" class="deactive <?php echo $auto_email['mail_admin'] == 0 ? 'selected' : '' ?>">
                            <span>Disable</span>
                        </a>
                        <a href="#" rel="mail_admin" title="Enable" class="active <?php echo $auto_email['mail_admin'] == 1 ? 'selected' : '' ?>">
                            <span>Enable</span>
                        </a>
                    </div>
                </div>	    
                <div class="form payment-setting">
                    <div class="form-item">
                        <div class="mail-template">
                            <div class="mail-input">
                                <?php wp_editor($mail_admin, 'mail_admin', je_editor_settings()); ?> 
                                <span class="icon" data-icon="3"></span>
                            </div>
                            <div class="mail-control-btn">
                                <div>(*)[reason] : <?php _e("um Arbeitsplätze auf Facebook Arbeit und newletter Blog veröffentlichen ", ET_DOMAIN) ?></div>
                                <a href="#" class="trigger-editor" ><?php _e('Toggle Editor', ET_DOMAIN) ?></a> | <a href="#" class="reset-default" ><?php _e('Reset to default', ET_DOMAIN) ?></a>
                            </div>
                        </div>
                    </div>
