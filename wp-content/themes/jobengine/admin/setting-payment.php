		...
		<div class="inner">
			...
			<div class="item">
				...
				<div class="form payment-setting">
					...
					<!-- <div class="">
						<div class="label">
							<input type="checkbox" id="2co_use_direct" name="2co_use_direct" value="<?php echo $_2CO_API['use_direct'] ?>"  <?php checked( $_2CO_API['use_direct'], 1 ); ?>  >
							<label for="2co_use_direct" ><?php _e("Use Direct Checkout",ET_DOMAIN);?> </label>
						</div>						
					</div> -->
				</div>
			</div>
