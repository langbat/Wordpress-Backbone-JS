        ...
        JobEngine.Views.Single_Job = Backbone.View.extend({
            ...
            initialize: function() {
                ...
                this.docs_uploader = new JobEngine.Views.File_Uploader({
                    ...
                    filters: [
                        ...
                        {title: 'Documents', extensions: 'pdf,doc,docx,zip,rar'},
                        {title: "Images", extensions: 'jpg,png,gif'}
                    ],
                    multipart_params: {
                ...
                pubsub.on('je:job:afterEditJob', function() {
                    location.reload()
                }, this);
            ...
            postApplication: function() {
                ...
                form_data = {
                    ...
                    apply_last_name: $apply_form.find('input#apply_last_name').val(),
