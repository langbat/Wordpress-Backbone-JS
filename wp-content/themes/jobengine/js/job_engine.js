...
// Model: Company
    ...
    JobEngine.Collections.Jobs = Backbone.Collection.extend({
        ...
        list_title: '',
        fetchData: {paged: 1, job_type: '', job_category: '', s: '', location: '', search_ambulances: '', search_hospitals: ''},
...
// View: AJAX Image Uploader
    JobEngine.Views.File_Uploader = Backbone.View.extend({
        initialize: function() {
            ...
            var acction = $("#job_list_container div.button-more #acction").val();
        ...
        styleSelect: function() {
            this.$(".select-style select").each(function() {
                ...
                if ($('option:selected', this).val() != '')
                    title = $('option:selected', this).text() + arrow;
                $(this)
