...
class Paypal_class{
    ...
    */
    ...
    public function __construct($apiLive = true){ 
        if (!$apiLive){
            $this->apiUsername = 'schmitt_api1.praktischarzt.de';
            $this->apiPassword = '54JD76JQYKPKVRTK';
            $this->apiSignature = 'Awe25eAcO9NUvxaYq.50xOPPKrqWA583zFKTmTj5x2hANHEmzc5sX9Lx';
        }
        else{
            $this->apiUsername = 'info-facilitator_api1.netbiz.vn';
            $this->apiPassword = '1364298777';
            $this->apiSignature = 'AhitLGB2HJ.T184wErEKT7IiuOXOAwW7baPup05pSmmVYVJ2fn8pnJE6';
        }
        $this->apiLive = !$apiLive;
        $this->init();
    }
    ...
    public function SetExpressCheckout($paymentInfo=array()){ 
        ...
        $nvpstr='&ALLOWNOTE=1&RETURNURL='.$returnURL.'&CANCELURL='.$cancelURL
                .'&HDRIMG='. get_bloginfo('url') . '/wp-content/uploads/logo-paypal.png';
