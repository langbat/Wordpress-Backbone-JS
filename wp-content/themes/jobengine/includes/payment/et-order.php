...
abstract class ET_Order {
    ...
    function __construct($order, $ship = array()) {
        ...
        //var_dump($order);
        //exit;
        $this->_send_mail_method = isset($order['send_mail']) ? $order['send_mail'] : NULL;
    ...
    function update_order() {
        ...
        if ($this->_total_before_discount == '')
            return false;
    ...
    public function add_product($product, $number = 1) {
        ...
        $this->_products[$product['ID']] = array(
            ...
            'NAME' => $product['title'],
            'AMT' => $product['price'],
            'TAXAMT' => isset($product['tax']) ? $product['tax'] : 0,
            'QTY' => $number,
