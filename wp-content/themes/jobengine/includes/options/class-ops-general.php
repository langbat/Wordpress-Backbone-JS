...
class ET_JobOptions extends ET_GeneralOptions {
    ...
    public function get_post_job_sidebar() {
        return $this->get_option('et_post_job_sidebar', array(
    ...
    public function get_upgrade_account_sidebar() {
        return $this->get_option('et_upgrade_account_widget', array(
                    'post_job_wid_1' => __('You can modify this text by clicking the edit button below or delete this box using the delete button', ET_DOMAIN))
        );
    }
    ...
    public function get_dashboard_sidebar() {
        return $this->get_option('et_dashboard_sidebar', array('dashboard_wid_1' => __('You can modify this text by clicking the edit button below or delete this box using the delete button', ET_DOMAIN)));
    }
    ...
    public function add_currency($code, $value) {
        $currency_list = $this->get_option('et_currency_list', array());
        $currency_list = array();
...
class ET_JobEngineMailTemplate extends ET_Options {
    ...
    public function __construct() {
        ...
        $this->opt_keys = array(
            ...
            'et_invoice_mail' => __("invoice mail", ET_DOMAIN),
            'et_email_send_admin_post_job' => __("Notification Post Job Admin", ET_DOMAIN)
        );
        $this->prefix = $et_global['db_prefix'];
    ...
    function reset_mail_template($mail) {
        ...
        switch ($mail) {
            ...
            case 'et_invoice_mail' :
                return $this->set_invoice_mail($new_value, true);
//            case 'et_email_send_admin_post_job' :
//                return $this->set_email_send_admin($new_value, true);
    ...
    public function get_email_send_user() {
        $default = __("<p>Hallo, [display_name]</p>
<p>Neu Stelle auf http://praktischarzt.de : <b>[job_title]</b></p>
<p>Sie haben gerade eine neue Stelle auf Webseite praktischarzt.de angelegt und möchten sie auf:<br/>
[email_method]
veröffentlicht werden.<br/>
Folgen Sie diesem Link, um Ihr Stellenangebot anzusehen:<br/>
<a href='[link_to_job]'>[link_to_job]</a></p>
<p>Bitte kontrolliere nochmals die Vollständigkeit der Stelle und Rechnung.</p>
<p>Viele Grüße,<br/> [blogname].</p>", ET_DOMAIN);
        return stripslashes(( $this->get_option('et_email_send_admin_post_job', $default)));
    }

    public function get_email_send_admin() {
        $default = __("<p>Hallo Admin praktischArzt,</p><br/>
<p><b>[display_name]</b> hat neue Stellen : <b>[job_title]</b></p>
<p><b>[display_name]</b> hat unsere Buchoptionen genutzt und möchte auf folgenden Medien veröffentlicht werden:<br/>
[email_method]
</p>
<p>Bitte kontrolliere nochmals die Vollständigkeit der Stelle und Rechnung.</p>
<p>Viele Grüße,<br/> [blogname].</p>", ET_DOMAIN);
    ...
    public function set_invoice_mail($new_value, $default) {
        if ($default) {
            $new_value = __("<p><b>Rechnungsnummer</b>:[invoice_number]</p><br/>
                <p><b>Betreff</b>:[invoice_subject]</p><br/><p>Hallo [display_name],</p>
                <p>Anbei erhalten Sie wie abgesprochen die Rechnung für aufgeführte Leistungen.</p>
                
                <p><table style='border: 1px solid #dddddd;border-collapse: separate;'> 
                <thead>
                    <tr>
                        <th style='border-left: 1px solid #dddddd;text-align: left;vertical-align: top;'>Position</th>
                        <th style='border-left: 1px solid #dddddd;text-align: left;vertical-align: top;'>Menge</th>
                        <th style='border-left: 1px solid #dddddd;text-align: left;vertical-align: top;'>Leistung</th>
                        <th style='border-left: 1px solid #dddddd;text-align: left;vertical-align: top;'>Form</th>
                        <th style='border-left: 1px solid #dddddd;text-align: left;vertical-align: top;'>Betrag (€)</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td style='border-left: 1px solid #dddddd;text-align: left;vertical-align: top;border-top: 1px solid #dddddd;'>[job_type]</td>
                        <td style='border-left: 1px solid #dddddd;text-align: left;vertical-align: top;border-top: 1px solid #dddddd;'>[job_quantity]</td>
                        <td style='border-left: 1px solid #dddddd;text-align: left;vertical-align: top;border-top: 1px solid #dddddd;'>[job_desc]</td>
                        <td style='border-left: 1px solid #dddddd;text-align: left;vertical-align: top;border-top: 1px solid #dddddd;'>[job_form]</td>
                        <td style='border-left: 1px solid #dddddd;text-align: left;vertical-align: top;border-top: 1px solid #dddddd;'>[job_payment_amount]</td> 
                    </tr>
                    <tr>
                        <td colspan='4' style='border-left: 1px solid #dddddd;text-align: left;vertical-align: top;border-top: 1px solid #dddddd;text-align:right'>Gesamtbetrag: </td>
                        <td style='border-left: 1px solid #dddddd;text-align: left;vertical-align: top;border-top: 1px solid #dddddd;'>[total_amount]</td>
                    </tr>
                    <tr>
                        <td colspan='4' style='border-left: 1px solid #dddddd;text-align: left;vertical-align: top;border-top: 1px solid #dddddd;text-align:right'>Zzgl. gesetzl. Mehrwertsteuer: </td>
                        <td style='border-left: 1px solid #dddddd;text-align: left;vertical-align: top;border-top: 1px solid #dddddd;'>[Excl_VAT]</td>
                    </tr>
                    <tr>
                        <td colspan='4' style='border-left: 1px solid #dddddd;text-align: left;vertical-align: top;border-top: 1px solid #dddddd;text-align:right'>Rechnungssumme: </td>
                        <td style='border-left: 1px solid #dddddd;text-align: left;vertical-align: top;border-top: 1px solid #dddddd;'>[total_bill]</td>
                    </tr>
                </tbody>
            </table></p>
                <p>Der Rechnungsbetrag ist 14 Tage nach Erhalt der Rechnung auf unten aufgeführtes Konto unter Angabe der Rechnungsnummer zu überweisen.</p>
                <p>Viele Grüße,<br/> [blogname].</p>", ET_DOMAIN);
        }
        $this->update_option('et_invoice_mail', $new_value);
        return $new_value;
    }

    public function get_invoice_mail() {
        $default = __("<p><b>Rechnungsnummer</b>:[invoice_number]</p><br/>
                <p><b>Betreff</b>: [invoice_subject]</p><br/><p>Hallo [display_name],</p><br />
                <p>anbei erhalten Sie die Rechnung für aufgeführte Leistungen.</p>
                <table cellspacing='0' cellpadding='0' width='100%'  style='margin-top: 20px; margin-bottom: 20px;' >
                <thead>
                    <tr>
                        <th style='width: 10%;padding: 5px;border-top: 1px solid #000;border-bottom: 1px solid #000;border-right:1px solid #000;'>Position</th>
                        <th style='width: 10%;padding: 5px;border-top: 1px solid #000;border-bottom: 1px solid #000;border-right:1px solid #000;'>Menge</th>
                        <th style='width: 65%; padding: 5px; text-align: left;border-top: 1px solid #000;border-bottom: 1px solid #000;border-right:1px solid #000;'>Leistung</th>
                        <th style='width: 15%;padding: 5px;border-top: 1px solid #000;border-bottom: 1px solid #000;'>Betrag (€)</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td style='text-align: left;vertical-align: top;border-top: 1px solid #000;'>[job_type]</td>
                        <td style='border-left: 1px solid #000;text-align: left;vertical-align: top;border-top: 1px solid #000;text-align:center'>[job_quantity]</td>
                        <td style='border-left: 1px solid #000;text-align: left;vertical-align: top;border-top: 1px solid #000;'>[job_desc]</td>
                        <td style='border-left: 1px solid #000;text-align: left;vertical-align: top;border-top: 1px solid #000;padding: 5px;text-align:right;'>[job_payment_amount]</td> 
                    </tr>
                    <tr>
                        <td colspan='3'  style='text-align: right; font-weight: bold;padding: 5px;border-right:1px solid #000;border-top:1px solid #000;border-bottom:1px solid #000;'>Gesamtbetrag: </td>
                        <td style='padding: 5px;border-top:1px solid #000;border-bottom:1px solid #000;text-align:right;'>[total_amount]</td>
                    </tr>
                    <tr>
                        <td colspan='3'  style='text-align: right; font-weight: bold;padding: 5px;border-right:1px solid #000;border-top:1px solid #000;border-bottom:1px solid #000;'>Zzgl. gesetzl. Mehrwertsteuer: </td>
                        <td style='padding: 5px;border-top:1px solid #000;border-bottom:1px solid #000;text-align:right;'>[Excl_VAT]</td>
                    </tr>
                    <tr>
                        <td colspan='3'  style='text-align: right; font-weight: bold;padding: 5px;border-right:1px solid #000;border-top:1px solid #000;border-bottom:1px solid #000;'>Rechnungssumme: </td>
                        <td style='padding: 5px;border-top:1px solid #000;border-bottom:1px solid #000;text-align:right;'>[total_bill]</td>
                    </tr>
                </tbody>
            </table>
                <p>Der Rechnungsbetrag ist 14 Tage nach Erhalt der Rechnung auf unten aufgeführtes Konto unter Angabe der Rechnungsnummer zu überweisen.</p>
                <br/><br/><br/><br/><p>Mit freundlichen Grüßen,<br/><br/>das Team von praktischArzt<br/></p>", ET_DOMAIN);
        return stripslashes(( $this->get_option('et_invoice_mail', $default)));
    }

    public function get_invoice_mail_debit() {
        $default = __("
            ...
            <br/><a href='[csv_file]'>[csv_file]</a></p>
                <p>Der Rechnungsbetrag ist 14 Tage nach Erhalt der Rechnung auf unten aufgeführtes Konto unter Angabe der Rechnungsnummer zu überweisen.</p>
                <p>Viele Grüße,<br/> [blogname].</p>", ET_DOMAIN);
        return $default;
    }

    public function get_invoice_mail_zertifikat() {
        return  __("<p><b>Rechnungsnummer</b>:[invoice_number]</p><br/>
                <p><b>Betreff</b>: [invoice_subject]</p><br/><p>Hallo [display_name],</p><br />
                <p>anbei erhalten Sie die Rechnung für aufgeführte Leistungen.</p>
                <table cellspacing='0' cellpadding='0' width='100%'  style='margin-top: 20px; margin-bottom: 20px;' >
                <thead>
                    <tr>
                        <th style='width: 10%;padding: 5px;border-top: 1px solid #000;border-bottom: 1px solid #000;border-right:1px solid #000;'>Menge</th>
                        <th style='width: 75%; padding: 5px; text-align: left;border-top: 1px solid #000;border-bottom: 1px solid #000;border-right:1px solid #000;'>Leistung</th>
                        <th style='width: 15%;padding: 5px;border-top: 1px solid #000;border-bottom: 1px solid #000;'>Betrag (€)</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td style='text-align: left;vertical-align: top;border-top: 1px solid #000;text-align:center'>1</td>
                        <td style='border-left: 1px solid #000;text-align: left;vertical-align: top;border-top: 1px solid #000;'>praktischArzt Zertifikat</td>
                        <td style='border-left: 1px solid #000;text-align: left;vertical-align: top;border-top: 1px solid #000;padding: 5px;text-align:right;'>[job_payment_amount]</td> 
                    </tr>
                    <tr>
                        <td colspan='2'  style='text-align: right; font-weight: bold;padding: 5px;border-right:1px solid #000;border-top:1px solid #000;border-bottom:1px solid #000;'>Gesamtbetrag: </td>
                        <td style='padding: 5px;border-top:1px solid #000;border-bottom:1px solid #000;text-align:right;'>[total_amount]</td>
                    </tr>
                    <tr>
                        <td colspan='2'  style='text-align: right; font-weight: bold;padding: 5px;border-right:1px solid #000;border-top:1px solid #000;border-bottom:1px solid #000;'>Zzgl. gesetzl. Mehrwertsteuer: </td>
                        <td style='padding: 5px;border-top:1px solid #000;border-bottom:1px solid #000;text-align:right;'>[Excl_VAT]</td>
                    </tr>
                    <tr>
                        <td colspan='2'  style='text-align: right; font-weight: bold;padding: 5px;border-right:1px solid #000;border-top:1px solid #000;border-bottom:1px solid #000;'>Rechnungssumme: </td>
                        <td style='padding: 5px;border-top:1px solid #000;border-bottom:1px solid #000;text-align:right;'>[total_bill]</td>
                    </tr>
                </tbody>
            </table>
    ...
    public function get_invoice_mail_debit_zertifikat() {
        $default = __("
                <p>Hallo [display_name],</p> 
                <p>Anbei erhalten Sie wie abgesprochen die Rechnung für aufgeführte Leistungen.</p>  
                <p>Gesamtbetrag: [total_amount]<br/>Zzgl. gesetzl. Mehrwertsteuer: [Excl_VAT]<br/>Rechnungssumme: [total_bill]<br/><a href='[csv_file]'>[csv_file]</a></p>
                <p>Der Rechnungsbetrag ist 14 Tage nach Erhalt der Rechnung auf unten aufgeführtes Konto unter Angabe der Rechnungsnummer zu überweisen.</p>
                <p>Viele Grüße,<br/> [blogname].</p>", ET_DOMAIN);
        return $default;
    }
